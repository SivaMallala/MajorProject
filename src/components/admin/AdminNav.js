...
const AdminNav = () => {
  ...
  return (
    <aside
      className="flex flex-col no-scrollbar px-6 py-7 bg-[#F6F6F6] gap-7 bg-sidebar shadow-2xl transition-all duration-300 ease-linear z-50 left-0 top-0 h-screen w-56 overflow-y-scroll translate-x-0 absolute lg:fixed"
    >
